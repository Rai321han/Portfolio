    ...
    <>
        ...
        {active && typeof active === "object" ? (
          <div className="fixed inset-0  grid place-items-center z-[100] p-3 bg-primaryDim ">
            ...
            <motion.button
              ...
              className="z-[1000] flex absolute bottom-5 md:top-2 md:right-2 lg:hidden items-center justify-center bg-white rounded-full h-14 w-14 md:h-10 md:w-10"
      ...
      <ul className=" w-full grid grid-cols-1 md:grid-cols-2 items-start gap-4">
        {cards.map((card) => (
          ...
          >
            <div className="grid gap-4 grid-cols-1 lg:grid-cols-2 w-full h-full">
