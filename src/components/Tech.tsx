...
export default function Tech() {
  ...
  return (
    <Section className="flex flex-col gap-4 items-center col-[1/14] md:col-[7/11] row-[5/6] md:row-[3/4] bg-primary rounded-[20px] border-y-[2px] border-borderColor p-[30px]">
